			 ...
			 <div class="container-fluid">
				<div class="top-logo">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img alt="<?php esc_attr_e ('Logo','geekfolio'); ?>" class="logo1 geekfolio-logo-dark" <?php echo esc_html($logo_height_style); ?> src="<?php 
						...
						<img alt="<?php esc_attr_e ('Logo','geekfolio'); ?>" class="logo1 geekfolio-logo-light" <?php echo esc_html($logo_height_style); ?> src="<?php 
