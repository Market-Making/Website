...
*/
if ( ! class_exists( 'Geekfolio_Wp_Bootstrap_Navwalker' ) ) {
    class Geekfolio_Wp_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        public static function fallback($args)
        {
            if (current_user_can('edit_theme_options')) {
                echo '<li><a href="' . admin_url('nav-menus.php') . '">' . esc_html__('Add a menu', 'geekfolio') . '</a></li>';
            }
        }
    }
}
...
if ( ! class_exists( 'Geekfolio_Menu_Navwalker' ) ) {
    class Geekfolio_Menu_Navwalker extends Walker_Nav_Menu 
    {
        public function start_lvl(&$output, $depth = 0, $args = array())
        {
            $indent = str_repeat("\t", $depth);
