	...
	<div class="col-lg-7">
		<div class="post-details">
			...
			<ul class="post-detail">
					...
					<li class="post-date"><i class="bi bi-clock me-1"></i> <?php echo esc_html(geekfolio_time_ago()); ?> </li>  	
			...
			<ul class="post-detail post-bot">
				...
				<li>
					...
					<div class="count"> <i class="bi bi-eye me-1"></i> <?php echo esc_html( geekfolio_get_post_view()); ?> </div>
				</li>
