<?php 
 $geekfolio_blog_popular_title  = geekfolio_option( 'geekfolio_blog_popular_title', 'Popular Posts' ); 
 $allow_html= array(
    'a' => array(
        'href' => array(),
        'title' => array()
...
<section class="popular-posts related Posts section-padding border-bottom brd-gray pt-50 pb-100">
                        <h5 class="fw-normal text-center text-uppercase mb-70"><?php echo wp_kses($geekfolio_blog_popular_title,$allow_html); ?></h5>
                                            ...
                                            <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                                                ...
                                                <div class="card-body px-0">
                                                    <small class="d-block date mt-10 fs-10px">
                                                        ...
                                                        <span class="op-8"><?php echo esc_html(__('Posted on', 'geekfolio').geekfolio_time_ago()); ?></span>
                                                    </small>
                                                    ...
                                                    <div class="d-flex small mt-20 align-items-center justify-content-between op-9">
                                                        ...
                                                        <div class="r-side mt-1">
                                                            ...
                                                            <span><?php echo esc_attr(geekfolio_get_post_view()); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
