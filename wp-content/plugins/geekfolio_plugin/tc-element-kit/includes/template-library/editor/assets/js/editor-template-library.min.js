    ...
    (a = {
        ...
        init: function () {
            ...
            (e.EpTemplateLibraryTemplateModel = Backbone.Model.extend({ defaults: { id: 0, template_id: 0, title: "", thumbnail: "", demo_url: "", is_pro: "", preview: "", source: "", package: "", date: "", categories: "" } })),
                ...
                (e.EpTemplateLoadingView = Marionette.ItemView.extend({ id: "tc-elementkit-template-library-loading", template: "#view-tc-elementkit-template-library-loading" })),
                (e.EpTemplateErrorView = Marionette.ItemView.extend({ id: "tc-elementkit-template-library-error", template: "#view-tc-elementkit-template-library-error" })),
                ...
                (e.EpTemplateProButton = Marionette.ItemView.extend({ template: "#view-tc-elementkit-template-library-pro-button", id: "tc-elementkit-template-library-pro-button" })),
        ...
        (t = {
            ...
            onPreviewLoaded: function () {
                ...
                window.elementor.$previewContents.on("click", ".elementor-editor-element-setting.elementor-editor-element-add", this.initLibraryButton),
                    window.elementor.$previewContents.on("click.addBdtElementKitTemplate", ".elementor-add-ep-button", _.bind(this.showTemplatesModal, this)),
            ...
            initLibraryButton: function () {
                var a = window.elementor.$previewContents.find(".elementor-add-new-section"),
                    l = '<div class="elementor-add-section-area-button elementor-add-ep-button"><i class="eicon-t-letter"></i></div>';
                a.find(".elementor-add-ep-button").length ||
                    (a.length && n.libraryButton && e(l).prependTo(a),
                    window.elementor.$previewContents.on("click.addBdtElementKitTemplate", ".elementor-editor-section-settings .elementor-editor-element-add", function () {
