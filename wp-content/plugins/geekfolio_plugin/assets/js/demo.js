 ...
 */
{
    ...
    class Slideshow {
        ...
        init() {
            this.DOM.slides = Array.from(this.DOM.el.querySelectorAll('.geekfolio-showcases .full-width-frame .slide'));
    ...
    new Slideshow(document.querySelector('.geekfolio-showcases .full-width-frame'));
