 ...
 * @since 1.0.0
 */
class Geekfolio_Icon_Box extends Widget_Base {
	...
	public function get_name() {
		return 'geekfolio-icon-box';
	}

	//script depend
	public function get_script_depends() { return ['geekfolio-icon-box' ]; }
	...
	public function get_title() {
		return __( 'Geekfolio Icon Box','geekfolio_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Icon Box', 'geekfolio_plg' ),
			]
		);
		...
		$this->add_control(
			'shape',
			[
				'label' => esc_html__( 'Shape', 'geekfolio_plg' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => esc_html__( 'Circle', 'geekfolio_plg' ),
					'square' => esc_html__( 'Square', 'geekfolio_plg' ),
				],
				'default' => 'circle',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'This is the heading', 'geekfolio_plg' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'geekfolio_plg' ),
				'placeholder' => esc_html__( 'Enter your description', 'geekfolio_plg' ),
				'rows' => 10,
				'separator' => 'none',
				'show_label' => false,
			]
		...
		$this->add_control(
			'position',
			[
				'label' => esc_html__( 'layout', 'geekfolio_plg' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'options' => [
					'left' => [
					...
					'top' => [
						'title' => esc_html__( 'Top', 'geekfolio_plg' ),
		...
		$this->add_control(
			'vertical_align',
			[
				'label' => __('Vertical Align', 'geekfolio_plg'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'flex-start' => __('Start', 'geekfolio_plg'),
					'center' => __('Center', 'geekfolio_plg'),
					'flex-end' => __('End', 'geekfolio_plg')
				],
				'default' => 'flex-start',
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box' => 'align-items: {{VALUE}} !important;'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box .elementor-icon-box-icon' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Item Settings', 'geekfolio_plg' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .geekfolio-icon-box',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Button Icon Background', 'geekfolio_plg'),
				'types' => [ 'classic','gradient' ],
				'selector' => '{{WRAPPER}} .geekfolio-icon-box:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px', '%', 'em'],
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'primary_color',
				'label' => __('Primary Color', 'geekfolio_plg'),
				'types' => [ 'classic', 'gradient' ],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Secondary Color', 'geekfolio_plg'),
				'types' => [ 'classic', 'gradient' ],
				'exclude' => ['image'],
		...
		$this->add_control(
			'icon_opacity',
			[
				'label' => esc_html__( 'Item Opacity', 'geekfolio_plg' ),
				...
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box:hover' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'icon_container_size',
			[
				'label' => esc_html__( 'Container Size', 'geekfolio_plg' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box .elementor-icon-box-icon .elementor-icon' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .geekfolio-icon-box .elementor-icon-box-icon .elementor-icon i' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'icon_lineheight',
			[
				'label' => esc_html__( 'Icon Line Height', 'geekfolio_plg' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box .elementor-icon-box-icon .elementor-icon' => 'line-height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .geekfolio-icon-box .elementor-icon-box-icon .elementor-icon i' => 'line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'img_filter_section',
			[
				'label' => esc_html__('Image filter', 'geekfolio_plg'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'image_revert',
			[
				'label' => esc_html__('Image Filter Revert', 'geekfolio_plg'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
		...
		$this->add_control(
			'image_sepia',
			[
				'label' => esc_html__('Image Filter Sepia', 'geekfolio_plg'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
                ...
                'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box img' => 'filter:  invert({{image_revert.SIZE}}%) sepia({{SIZE}}%) brightness( {{image_filter_brightness.SIZE}}% ) contrast( {{image_filter_contrast.SIZE}}% ) saturate( {{image_filter_saturate.SIZE}}% ) blur( {{image_filter_blur.SIZE}}px ) hue-rotate( {{image_filter_hue.SIZE}}deg ) !important;'
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .geekfolio-icon-box:hover img',
			]
		);
		...
		$this->start_controls_section(
			'icon_drop_shadow',
			[
				'label' => esc_html__('Icon Drop Shadow', 'geekfolio_plg'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Alignment', 'geekfolio_plg' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'top' => esc_html__( 'Top', 'geekfolio_plg' ),
					'middle' => esc_html__( 'Middle', 'geekfolio_plg' ),
					'bottom' => esc_html__( 'Bottom', 'geekfolio_plg' ),
				],
				'default' => 'top',
				'prefix_class' => 'geekfolio-icon-box-vertical-align-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box:hover .elementor-icon-box-title' => 'color: {{VALUE}};',
					'{{WRAPPER}} .geekfolio-icon-box:hover .elementor-icon-box-title a' => 'color: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_PRIMARY,
				],
		...
		$this->add_responsive_control(
			'title_margin',
			[
				'label' => __('Title Margin', 'geekfolio_plg'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
                'selectors' => [
					'@media (prefers-color-scheme: dark){ body.geekfolio-auto-mode {{WRAPPER}} .elementor-icon-box-description' => 'color: {{VALUE}};',
					'} body.geekfolio-dark-mode {{WRAPPER}} .elementor-icon-box-description' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .geekfolio-icon-box:hover .elementor-icon-box-description' => 'color: {{VALUE}};',
				],
				'global' => [
		...
		$this->add_responsive_control(
			'description_margin',
			[
				'label' => __('Description Margin', 'geekfolio_plg'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Additional Description Settings', 'geekfolio_plg' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Additional Description typography', 'geekfolio_plg' ),
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Additional Description color', 'geekfolio_plg' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
	...
	protected function render() {
		...
		?>
		<div class="geekfolio-icon-box <?php echo esc_attr($icon_pos); ?> elementor-icon-box-wrapper">
			<?php if ( $has_icon or $has_image ) : ?>
			<div class="elementor-icon-box-icon <?php if($settings['invert_dark'] == 'yes') echo ' invert-dark'; ?>">
			...
			<?php if (!empty($settings['link']['url'])) { ?>
				<a href="<?php echo esc_url($settings['link']['url']); ?>" <?php if ( $settings['link']['is_external'] ) {echo'target="_blank"';} ?> class="geekfolio-icon-box-link"> </a> 
			<?php } ?>
		</div>
		<?php
	}
