...
add_action( 'widgets_init', 'geekfolio_plg_n');

if( !function_exists('geekfolio_plg_n') ){
function geekfolio_plg_n() {

   /**
    * Registering widget areas for front page
    */
   register_widget( "geekfolio_newsletter_widget" );
}}


class geekfolio_newsletter_widget extends WP_Widget {

    public function __construct() {
        $widget_ops = array('classname' => 'geekfolio_newsletter_widget', 'description' => __('geekfolio newsletter'));
        $control_ops = array('width' => 100, 'height' => 100);
        parent::__construct('texti', __('Geekfolio Newsletter'), $widget_ops, $control_ops);
    }
