...
if( ! function_exists( 'geekfolio_breadcrumbs' )){

	function geekfolio_breadcrumbs(){
			


		# breadcrumbs ----------

		$home_text  = esc_html__( 'Home', 'geekfolio' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){			
				...
				if ( get_post_type() == 'post' ){
					...
					$category = geekfolio_get_primary_category_id();
					$category = get_category( $category );
